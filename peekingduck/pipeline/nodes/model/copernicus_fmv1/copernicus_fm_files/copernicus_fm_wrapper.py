...
from peekingduck.pipeline.nodes.model.copernicus_fmv1.copernicus_fm_files.models_dwv import vit_base_patch16 as vit_base_patch16_cls
from peekingduck.pipeline.nodes.model.copernicus_fmv1.copernicus_fm_files.models_dwv import vit_large_patch16 as vit_large_patch16_cls
from peekingduck.pipeline.nodes.model.copernicus_fmv1.copernicus_fm_files.models_dwv import vit_small_patch16 as vit_small_patch16_cls
from peekingduck.pipeline.nodes.model.copernicus_fmv1.copernicus_fm_files.models_dwv_seg import vit_base_patch16 as vit_base_patch16_seg
from peekingduck.pipeline.nodes.model.copernicus_fmv1.copernicus_fm_files.models_dwv_seg import vit_large_patch16 as vit_large_patch16_seg
from peekingduck.pipeline.nodes.model.copernicus_fmv1.copernicus_fm_files.models_dwv_seg import vit_small_patch16 as vit_small_patch16_seg

from peekingduck.pipeline.nodes.model.copernicus_fmv1.copernicus_fm_files.feature_2_pyramid import Feature2Pyramid
from peekingduck.pipeline.nodes.model.copernicus_fmv1.copernicus_fm_files.uper_head import UPerHead
from peekingduck.pipeline.nodes.model.copernicus_fmv1.copernicus_fm_files.fcn_head import FCNHead
from peekingduck.pipeline.nodes.model.copernicus_fmv1.copernicus_fm_files.lightning_task import LightningTask
from peekingduck.pipeline.nodes.model.copernicus_fmv1.copernicus_fm_files.misc import (
    seg_metric, cls_metric, reg_metric, resize,
)
...
class CopernicusFMClassification(LightningTask):
    ...
    def forward(self, samples, metas):
        out_logits, feats = self.encoder(
            samples, 
            metas, 
            self.data_config.key, 
            self.data_config.band_wavelengths, 
            self.data_config.band_bandwidths, 
            self.language_embed, 
            self.data_config.input_mode, 
            self.data_config.kernel_size
        )
