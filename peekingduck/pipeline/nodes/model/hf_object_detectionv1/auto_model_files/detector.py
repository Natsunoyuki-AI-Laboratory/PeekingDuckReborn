...
"""Detector module to predict object bbox from an image."""
...
class Detector:  # pylint: disable=too-many-instance-attributes
    """Object detection class using AutoModelForObjectDetection to predict 
    object bboxes.

    Attributes:
        logger (logging.Logger): Events logger.
        config (Dict[str, Any]): AutoModelForObjectDetection node configuration.
        ...
        device (torch.device): Represents the device on which the torch.Tensor
            will be allocated.
        model (AutoModelForObjectDetection): The AutoModelForObjectDetection 
            model for performing inference.
        image_processor (AutoImageProcessor): The AutoModelForObjectDetection 
            image processor.
    """
